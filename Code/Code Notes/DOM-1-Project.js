...
function timer () {
    ...
    function init () {
        ...
        const timerInterval = window.setInterval(() => { // you can call setInterval without window, but window just specifies the scope at which the information can be found - aka Global/Window.
